...
export function buildAdminPrimaryNav(state: State): AdminNavItem[] {
  ...
  return [
    ...
    { id: "principles", label: "Principles",  href: `${ADMIN_BASE}/principles`,    icon: ListChecks,      count: state.principles.length || null },
    { id: "timeline",   label: "Timeline",    href: `${ADMIN_BASE}/timeline`,      icon: Milestone,       count: state.timeline.length || null },
