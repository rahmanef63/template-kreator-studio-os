 ...
 *   kreatorOrders row + DOKU Direct payment) → redirect to /order/[id]
    ...
    return (
      <div className="mx-auto max-w-2xl space-y-4 px-6 py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Pilih paket dari halaman pricing dulu, lalu kembali ke sini untuk membayar.
        </p>
        <Button asChild>
          <Link href={`${PUBLIC_BASE}/pricing`}>Lihat paket</Link>
        </Button>
      </div>
    );
  }
